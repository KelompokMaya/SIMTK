...
<html>
    <head>
        ...
        <!-- DataTables -->
        <link href="<?php echo base_url('assets/AdminLTE-2.3.11/plugins/datatables/dataTables.bootstrap.css') ?>" rel="stylesheet" type="text/css">
        <!-- Theme style -->
        <link href="<?php echo base_url('assets/AdminLTE-2.3.11/dist/css/AdminLTE.min.css') ?>" rel="stylesheet" type="text/css" />
        ...
        <!-- preloader kim -->
        <link href="<?php echo base_url('assets/admin/css/preloaderKIM.css') ?>" rel="stylesheet" type="text/css" />
